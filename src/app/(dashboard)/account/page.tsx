...
export default function AccountPage() {
  ...
  return (
    <div className="flex flex-col w-full h-full text-white pb-10">
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-outfit font-bold text-white drop-shadow-md mb-2">Player Account</h1>
        <p className="text-gray-400">Manage your characters and digital currencies.</p>
      </div>
